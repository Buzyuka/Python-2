...
try:
    ...
    request = build_presence_status_request(account_name=account_name, status="write")
    sock.send(request)
    ...
    while True:
        ...
        request = build_message_request(account_name=account_name, room="main", message=msg)
        sock.send(request)
